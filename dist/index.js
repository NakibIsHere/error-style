...
export async function prettyTryAsync(fn) {
    try {
...
export function formatError(errorExplanation) {
    const colors = {
        reset: '\x1b[0m',
        brightRed: '\x1b[91m',
...
export function logError(errorExplanation) {
